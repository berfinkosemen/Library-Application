<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_sign_in.aspx.cs" Inherits="Kutuphane_Uygulamasi.user_sign_in" %>
        ...
        <div>
            <div style="position:absolute; z-index:1;" id="layer1">
                <div class="modal-body" style="margin:5px 0px 0px 550px;">
                    <div class="row">
                        <div class="col-xl-12">
                            <label for="user_login" class="control-label" style="color:black;font-size:26px;font-weight:bold">Kullanıcı Girişi</label>
